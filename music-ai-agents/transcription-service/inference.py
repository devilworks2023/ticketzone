"""Envoltorio de inferencia de MT3 (transcripción multi-instrumento a MIDI).

Basado en el colab oficial de MT3 (magenta/mt3), adaptado para ejecutarse como
servicio: rutas de gin y checkpoint por variables de entorno, sin dependencias
de Google Colab.
"""
...
SAMPLE_RATE = 16000
GIN_DIR = os.environ.get("MT3_GIN_DIR", "/mt3/mt3/gin")


class InferenceModel:
    """Modelo T5X de MT3 para transcripción musical."""
    ...
    def __init__(self, checkpoint_path, model_type="mt3"):
        if model_type == "ismir2021":
            ...
            raise ValueError("model_type desconocido: %s" % model_type)
